...
import es.aldaba.gdpr.config.audit.AuditEventConverter;
import es.aldaba.gdpr.domain.PersistentAuditEvent;
...
import static es.aldaba.gdpr.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
