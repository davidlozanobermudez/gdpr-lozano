...
import es.aldaba.gdpr.config.Constants;
import es.aldaba.gdpr.domain.Authority;
import es.aldaba.gdpr.domain.User;
import es.aldaba.gdpr.repository.AuthorityRepository;
import es.aldaba.gdpr.repository.UserRepository;
import es.aldaba.gdpr.security.AuthoritiesConstants;
import es.aldaba.gdpr.service.MailService;
import es.aldaba.gdpr.service.UserService;
import es.aldaba.gdpr.service.dto.PasswordChangeDTO;
import es.aldaba.gdpr.service.dto.UserDTO;
import es.aldaba.gdpr.web.rest.errors.ExceptionTranslator;
import es.aldaba.gdpr.web.rest.vm.KeyAndPasswordVM;
import es.aldaba.gdpr.web.rest.vm.ManagedUserVM;
