...
import { IContacto, Contacto, StatusContacto } from 'app/shared/model/contacto.model';
...
describe('Service Tests', () => {
    describe('Contacto Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Contacto(0, 'AAAAAAA', StatusContacto.ACTIVO, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
