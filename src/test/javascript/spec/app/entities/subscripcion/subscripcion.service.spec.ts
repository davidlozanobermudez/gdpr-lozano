...
describe('Service Tests', () => {
    describe('Subscripcion Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Subscripcion(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Subscripcion', async () => {
            ...
            it('should update a Subscripcion', async () => {
                const returnedFromService = Object.assign(
                    {
                        codigo: 'BBBBBB'
                    },
            ...
            it('should return a list of Subscripcion', async () => {
                const returnedFromService = Object.assign(
                    {
                        codigo: 'BBBBBB'
                    },
            ...
            it('should delete a Subscripcion', async () => {
